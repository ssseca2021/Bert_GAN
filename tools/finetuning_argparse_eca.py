...
def get_argparse():
    ...
    parser.add_argument("--hidden_size", default=768, type=float, help=".")
    ...
    parser.add_argument("--cause_num", type=int, default=3, help="random seed for initialization")
    parser.add_argument("--local_rank", type=int, default=-1, help="For distributed training: local_rank")
    parser.add_argument("--save_name", type=str, default="ch", help="For distant debugging.")
    parser.add_argument("--heads", type=int, default= 3, help="")
    parser.add_argument("--alpha", type=float, default= 0.2, help="")
    
    parser.add_argument("--Gra", type=int, default= 5, help="")
    parser.add_argument("--GraV", type=float, default= 0.5, help="")
